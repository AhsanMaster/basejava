...
- Реализуйте класс `com.github.ahsanmaster.basejava.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
```
- Протестируйте вашу реализацию с помощью классов `com.github.ahsanmaster.basejava.MainArray.main()` и `com.github.ahsanmaster.basejava.MainTestArrayStorage.main()`
...
6. `com.github.ahsanmaster.basejava.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
